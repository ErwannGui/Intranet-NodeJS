...
$(document).ready(function(){
    ...
    $('.exportSVG, .exportPNG').click(function () {
        $('.dynamic-data-container span').style.color = "#000!important";
    });

    $('#charts .collapsible-header').click(function(){
        var collapsible = $(this).parent();
        if(!$('iframe', collapsible).length) {
            $('.collapsible-body:not(.dynamic-data-container)', collapsible).html('<iframe id="sample-dashboard"\n' +
    ...
    $('.datatable').each(function () {
        $(this).dataTable({
            "oLanguage": {
                "sSearch": "",
                "sSearchPlaceholder": "Rechercher une valeur ...",
            ...
            buttons: [
                {
                    text: '<span style="color:#4d4d4d; margin-right:15px">Imprimer<span>',
                    extend: 'print',
                    className: '',
                    title: '',
                    //  autoPrint: false,
